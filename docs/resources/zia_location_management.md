...
## Example Usage - VZEN Cluster Location Management
...
resource "zia_location_management" "this"  {
    ...
    dn_bandwidth                = 1000
    vpn_credentials {
       id = zia_traffic_forwarding_vpn_credentials.this.id
       type = "UFQDN"
       fqdn = "sjc-1-37@securitygeek.io"
    }
    virtual_zen_clusters {
      id = [ zia_virtual_service_edge_cluster.this.id ]
    }
}

## Example Usage - VZEN Nodes Location Management
