...
---
# Data Source: zia_firewall_dns_rules

Use the **zia_firewall_dns_rules** data source to get information about a cloud firewall DNS rule available in the Zscaler Internet Access.
