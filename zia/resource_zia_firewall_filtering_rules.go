...
func expandFirewallFilteringRules(d *schema.ResourceData) filteringrules.FirewallFilteringRules {
	...
	result := filteringrules.FirewallFilteringRules{
		...
		LocationsGroups:     expandIDNameExtensionsList(d, "location_groups"),
		...
		SrcIpGroups:         expandIDNameExtensionsList(d, "src_ip_groups"),
		DestIpGroups:        expandIDNameExtensionsList(d, "dest_ip_groups"),
		NwServices:          expandIDNameExtensionsList(d, "nw_services"),
		NwServiceGroups:     expandIDNameExtensionsList(d, "nw_service_groups"),
		NwApplicationGroups: expandIDNameExtensionsList(d, "nw_application_groups"),
		AppServices:         expandIDNameExtensionsList(d, "app_services"),
		AppServiceGroups:    expandIDNameExtensionsList(d, "app_service_groups"),
