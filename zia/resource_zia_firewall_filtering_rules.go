...
func resourceFirewallFilteringRules() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"time_windows":          setIDsSchemaTypeCustom(nil, "list of time interval during which rule must be enforced."),
			"labels":                setIDsSchemaTypeCustom(nil, "list of Labels that are applicable to the rule."),
