...
func resourceFirewallFilteringRules() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"locations":             listIDsSchemaType("list of locations for which rule must be applied"),
			"groups":                listIDsSchemaType("list of groups for which rule must be applied"),
			"departments":           listIDsSchemaType("list of departments for which rule must be applied"),
			"users":                 listIDsSchemaType("list of users for which rule must be applied"),
			...
			"nw_services":           listIDsSchemaType("list of nw services"),
		},
	}
}
