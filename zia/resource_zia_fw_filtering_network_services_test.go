...
func TestAccZIAResourceFWNetworkServicesBasic(t *testing.T) {
	...
	skipAcc := os.Getenv("SKIP_FW_NETWORK_SERVICES")
	if skipAcc == "yes" {
		t.Skip("Skipping network services test as SKIP_FW_NETWORK_SERVICES is set")
	}
