...
resource "zia_activation_status" "example1"{
    status = "ACTIVE"
    depends_on = [ zia_traffic_forwarding_gre_tunnel.example1, zia_traffic_forwarding_gre_tunnel.example2, zia_traffic_forwarding_static_ip.example_1, zia_traffic_forwarding_static_ip.example_2 ]
}
